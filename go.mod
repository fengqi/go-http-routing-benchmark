module github.com/fengqi/go-http-routing-benchmark
...
require (
	...
	github.com/typepress/rivet v1.1.0
...
replace github.com/plimble/sessions v0.0.0-20180326075456-7047d39da9ad => github.com/fengqi/sessions v0.0.0-20190419103456-7fc7ee507551
